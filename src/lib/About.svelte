<section class="flex flex-col justify-center items-center min-h-[calc(100vh)] mt-48">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-48 w-full">
        <div class="flex flex-col items-center text-center">
            ...
            <a href="https://www.linkedin.com/in/martin-studna/" class="mt-4" target="_blank" rel="noopener noreferrer" aria-label="martin-link">
                <svg class="w-6 h-6 text-[#0A66C2] hover:text-[#004182] transition-colors" fill="currentColor" viewBox="0 0 24 24">
